...
const uint8_t MASS_StringVendor[MASS_SIZ_STRING_VENDOR] =
  {
    ...
    /* Manufacturer: "www.sl-alex.com.ua" */
    'w', 0, 'w', 0, 'w', 0, '.', 0, 's', 0, 'l', 0, '-', 0, 'a', 0,
    'l', 0, 'e', 0, 'x', 0, '.', 0, 'c', 0, 'o', 0, 'm', 0, '.', 0,
    'u', 0, 'a', 0
  };
const uint8_t MASS_StringProduct[MASS_SIZ_STRING_PRODUCT] =
  {
    ...
    'W', 0, 'i', 0, 'N', 0, 'e', 0, 't', 0, ' ', 0, 'U', 0, 'S', 0, 'B', 0,
    't', 0, 'r', 0, 'a', 0, 'n', 0, 's', 0, 'c', 0, 'e', 0, 'i', 0, 'v', 0, 'e', 0, 'r', 0
